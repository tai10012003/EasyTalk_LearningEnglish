...
const AddPronunciation = () => {
    ...
    return <AddLesson onSubmit={handleSubmit} returnUrl="/admin/pronunciation" title="THÊM BÀI HỌC PHÁT ÂM" existingItems={existingPronunciations} modulesByLevel={PRONUNCIATION_MODULES_BY_LEVEL}/>;
};
