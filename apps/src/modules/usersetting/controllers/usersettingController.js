...
function createUserSettingController({ userSettingService }) {
    if (!userSettingService) {
        throw new Error("createUserSettingController requires userSettingService");
    }
...
module.exports = { createUserSettingController };
