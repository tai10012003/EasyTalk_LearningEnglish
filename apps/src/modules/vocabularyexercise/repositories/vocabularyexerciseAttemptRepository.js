...
class VocabularyExerciseAttemptRepository {
    constructor() {
        this.client = DatabaseConnection.getMongoClient();
        this.db = this.client.db(config.mongodb.database);
        this.collection = this.db.collection("vocabularyexerciseattempts");
        this.ensureIndexes();
    }

    ensureIndexes() {
        this.collection.createIndex({ userId: 1, vocabularyExerciseId: 1, createdAt: -1 }).catch(() => {});
...
module.exports = VocabularyExerciseAttemptRepository;
