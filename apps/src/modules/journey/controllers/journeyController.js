...
function createJourneyController({ journeyService, gateService, userProgressService }) {
    if (!journeyService || !gateService || !userProgressService) {
        throw new Error("createJourneyController requires journeyService, gateService, and userProgressService");
    }
...
module.exports = { createJourneyController };
