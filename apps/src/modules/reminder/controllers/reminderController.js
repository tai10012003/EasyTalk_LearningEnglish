...
function createReminderController({ reminderService, notificationService }) {
    if (!reminderService) {
        throw new Error("createReminderController requires reminderService");
    }
    ...
    router.reminderService = reminderService;
    return router;
}
