    ...
    async createJsonCompletion({ task }) {
        ...
        if (task === "provider_health_check") {
            return this.buildJsonResponse({
                ok: true,
                message: "Claude provider adapter skeleton is ready."
            });
        }
        throw this.createNotImplementedError("Claude live adapter skeleton is registered, but real API calls are not implemented yet.");
    }
...
module.exports = ClaudeProviderAdapter;
