...
weakSkills must use only these values: grammar, vocabulary, pronunciation, listening, speaking, writing.
...
Strict JSON schema: {"summary":"string","mistakes":["string"],"weakSkills":["grammar|vocabulary|pronunciation|listening|speaking|writing"],"recommendedNextActions":[{"type":"string","title":"string","path":"string"}]}.
