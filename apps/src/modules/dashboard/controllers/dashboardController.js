...
router.get("/user-activity", verifyToken, async (req, res) => {
    try {
        ...
        res.status(500).json({ success: false, message: error.message || "Lỗi khi lấy dữ liệu hoạt động người dùng" });
    }
});
...
router.get("/overview", verifyToken, async (req, res) => {
    try {
        ...
        res.status(500).json({ success: false, message: error.message || "Lỗi khi lấy tổng quan dashboard" });
    }
});
...
router.get("/lesson-breakdown", verifyToken, async (req, res) => {
    try {
        ...
        res.status(500).json({ success: false, message: error.message || "Lỗi khi lấy tỷ lệ bài học" });
    }
});
...
router.get("/exercise-breakdown", verifyToken, async (req, res) => {
    try {
        ...
        res.status(500).json({ success: false,message: error.message || "Lỗi khi lấy tỷ lệ bài luyện tập" });
    }
});
...
router.get("/recent-activities", verifyToken, async (req, res) => {
    try {
        ...
        res.status(500).json({ success: false,message: error.message || "Lỗi khi lấy hoạt động gần đây" });
    }
});
...
router.get("/top-users-exp", verifyToken, async (req, res) => {
    try {
        ...
        res.status(500).json({ success: false,message: error.message || "Lỗi khi lấy bảng xếp hạng theo điểm kinh nghiệm" });
    }
});
...
router.get("/top-users-study-time", verifyToken, async (req, res) => {
    try {
        ...
        res.status(500).json({ success: false,message: error.message || "Lỗi khi lấy bảng xếp hạng theo thời gian học" });
    }
});
...
router.get("/top-users-streak", verifyToken, async (req, res) => {
    try {
        ...
        res.status(500).json({ success: false,message: error.message || "Lỗi khi lấy bảng xếp hạng theo streak" });
    }
});
...
router.get("/lesson-completion-stats", verifyToken, async (req, res) => {
    try {
        ...
        res.status(500).json({ success: false,message: error.message || "Lỗi khi lấy thống kê hoàn thành bài học" });
    }
});
...
router.get("/exercise-completion-stats", verifyToken, async (req, res) => {
    try {
        ...
        res.status(500).json({ success: false,message: error.message || "Lỗi khi lấy thống kê hoàn thành bài tập" });
    }
});
...
router.get("/most-popular-lessons", verifyToken, async (req, res) => {
    try {
        ...
        res.status(500).json({ success: false,message: error.message || "Lỗi khi lấy bài học phổ biến nhất" });
    }
});
...
router.get("/most-popular-exercises", verifyToken, async (req, res) => {
    try {
        ...
        res.status(500).json({ success: false,message: error.message || "Lỗi khi lấy bài tập phổ biến nhất" });
    }
});
...
router.get("/least-popular-lessons", verifyToken, async (req, res) => {
    try {
        ...
        res.status(500).json({ success: false,message: error.message || "Lỗi khi lấy bài học khó nhất" });
    }
});
...
router.get("/least-popular-exercises", verifyToken, async (req, res) => {
    try {
        ...
        res.status(500).json({ success: false,message: error.message || "Lỗi khi lấy bài tập khó nhất" });
    }
});
